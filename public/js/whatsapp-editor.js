(function ($) {
    $.fn.whatsappEditor = function (options) {
        ...
        function initToolbar($parentElement) {
            ...
            if (settings.breakline) {
                $("<a/>")
                    ...
                    .append("<span class=''>Enter/Breakline</span>")
                    .on("click", function (e) {
                        var value = " %0a .";
                        format("breakline", value);
                    })
                    .appendTo($toolbar);
            }
            if (settings.bold) {
            ...
            if (settings.smiles) {
                var $dropdown = $("<a/>")
                    ...
                    .attr("href", "javascript:void(0)");
                var $dropdownContent = $("<div/>").addClass(
        ...
        function format(command, value) {
            ...
            } else if (command === "smile" || command === "breakline") {
        ...
        this.getFormattedContent = function () {
            if (this.length && this.length === 1) {
                return prepareFormattedContent(
                    this.find(".whatsapp-editor").html()
                );
            } else {
                var contents = [];
        ...
        function prepareFormattedContent(htmlContent) {
            htmlContent = htmlContent
                ...
                .replace(
                    /<font face="monospace" style="">|<font face="monospace">|<\/font>/g,
                    "```"
                );
