        ...
        <div class="row">
            ...
            <form class="col-md-12" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="number" class="form-control" id="member_phone" placeholder="Enter Member" name="member_phone" value="<?=$posts["member_phone"];?>">
                </div>
            ...
            <div class="col-md-12">
                <table id="example" class="table table-hover table-stripped table-bordered" >
                    ...
                    <tbody>
                        ...
                        ->where("member.tranprod_id","=",$_GET["layananid"])
